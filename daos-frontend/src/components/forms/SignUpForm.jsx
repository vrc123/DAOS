...
export default function SignUpForm() {
  ...
  function signUp(e) {
    ...
    const validationArray = Validation(profile);
  ...
  return (
    <form className={styles.signUpFormDefault} onSubmit={signUp}>
      ...
      <InputTagText
        inputText="E-mail"
        value={email}
        inputTextFunction={emailProp}
      />
      <InputTagText
        inputText="Password"
        value={password}
        inputTextFunction={passwordProp}
      />
      <div>
        <InputTagCheckbox
          value={conditions}
          inputCheckboxFunction={conditionsProp}
        />
        <p className={styles.pCustom}>
          I accept the <Link to="#">conditions</Link>
        </p>
      </div>
      <div>
        <InputTagCheckbox
          value={newsletter}
          inputCheckboxFunction={newsletterProp}
        />
        <PTag
          pType="small"
          pColor="grey"
          pText="Sign up for the DAOS newsletter"
        />
      </div>
      {!isLoading && (
        <ButtonTag
